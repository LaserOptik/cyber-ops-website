...
I can confirm that HackTheBox is absolutely a proper platform to get more than well prepared to get into OSCP and I'd like to thanks to TJNull for elaborating that useful OSCP-like machines list since it was very helpful for me. Anyway, I will make a [personal list](https://xma.cyber-ops.es/posts/my-oscp-like-hackthebox-machines-tier-list/) in a separated post about those which I considered the best machines in terms of learning and being OSCP-like.t.
